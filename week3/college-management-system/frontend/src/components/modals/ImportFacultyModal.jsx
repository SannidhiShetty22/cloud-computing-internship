                    ...
                    <div className="space-y-8">
                        ...
                        <div className="rounded-xl border border-zinc-100 bg-zinc-50 p-6 dark:border-zinc-800/60 dark:bg-zinc-950/50">
                            ...
                            <label className="block">
                                <span className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl border-2 border-dashed border-zinc-200 bg-white px-6 py-4 text-[10px] font-black uppercase tracking-widest transition-all hover:border-blue-400 hover:text-blue-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:border-blue-500">
                                    <Upload size={18} />
