...
const FacultyDashboard = () => {
    ...
    return (
        <div className="pb-12 font-sans bg-zinc-50 dark:bg-zinc-950 min-h-screen transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <section className="lg:col-span-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 sm:p-8 shadow-sm h-full flex flex-col">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 flex-1">
                            <div className="flex flex-col gap-3 p-5 rounded-xl bg-zinc-50 dark:bg-zinc-950/50 border border-zinc-100 dark:border-zinc-800/60">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-zinc-800 dark:text-zinc-200 mb-1">Academic Records</h4>
                            ...
                            <div className="flex flex-col gap-3 p-5 rounded-xl bg-zinc-50 dark:bg-zinc-950/50 border border-zinc-100 dark:border-zinc-800/60">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-zinc-800 dark:text-zinc-200 mb-1">Real-Time Updates</h4>
                                    <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
                    ...
                    <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 sm:p-8 shadow-sm">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <QuickActionLink to="/faculty/enter-marks" icon={GraduationCap} label="Manage Marks" color="indigo" />
                            <QuickActionLink to="/faculty/take-attendance" icon={ClipboardCheck} label="Attendance" color="emerald" />
                            <QuickActionLink to="/faculty/profile" icon={BookOpen} label="My Subjects" color="slate" />
                        </div>
                    </section>
