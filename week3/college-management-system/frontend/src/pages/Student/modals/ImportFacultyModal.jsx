...
const ImportFacultyModal = ({ token, onClose, onImportSuccess }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <div
                className="relative bg-white dark:bg-zinc-900 w-full max-w-2xl rounded-xl shadow-2xl z-10 overflow-hidden border border-zinc-200 dark:border-zinc-800 animate-in fade-in zoom-in-95 duration-300">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-zinc-50 dark:bg-zinc-950/50 p-6 rounded-xl border border-zinc-100 dark:border-zinc-800/60">
                            ...
                            <label className="block">
                                <span
                                    className="flex items-center justify-center gap-3 w-full px-6 py-4 bg-white dark:bg-zinc-800 border-2 border-dashed border-zinc-200 dark:border-zinc-700 text-[10px] font-black uppercase tracking-widest rounded-xl hover:border-indigo-400 dark:hover:border-indigo-500 hover:text-indigo-600 transition-all cursor-pointer dark:text-zinc-300">
                                    <Upload size={18} />
                        ...
                        <div className="space-y-4">
                            ...
                            {result && (
                                <div
                                    className="w-full bg-emerald-50 dark:bg-emerald-500/5 border border-emerald-100 dark:border-emerald-500/20 rounded-xl p-6 text-[11px] font-bold text-zinc-700 dark:text-zinc-300 grid grid-cols-2 gap-4 animate-in zoom-in-95">
                                    <div className="space-y-1">
                                        <p className="text-zinc-400 uppercase text-[9px] tracking-widest">Total Rows</p>
