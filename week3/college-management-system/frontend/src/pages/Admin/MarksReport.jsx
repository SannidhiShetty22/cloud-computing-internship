            ...
            <main className="flex-1 max-w-7xl w-full mx-auto px-3 sm:px-6 py-6 space-y-6">
                ...
                <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm p-4 sm:p-6 transition-all">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h2 className="text-xs font-bold uppercase text-zinc-500 dark:text-zinc-400 tracking-wider">Report Selection</h2>
                    </div>
                ...
                {loading ? (
                            ...
                            <div className="border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950/50">
                                <table className="w-full table-fixed">
                                    ...
                                    <tr>
                                        ...
                                        <th className="w-[15%] px-2 sm:px-4 py-4 text-center text-[10px] sm:text-xs font-bold text-zinc-500 uppercase tracking-wider">Theory</th>
                                        <th className="w-[15%] px-2 sm:px-4 py-4 text-center text-[10px] sm:text-xs font-bold text-zinc-500 uppercase tracking-wider">Pract.</th>
                                        <th className="hidden sm:table-cell w-[15%] px-4 py-4 text-center text-[10px] sm:text-xs font-bold text-zinc-500 uppercase tracking-wider">Total</th>
                                        <th className="w-[15%] px-4 py-4 text-center text-[10px] sm:text-xs font-bold text-zinc-500 uppercase tracking-wider">Grade</th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
                                ...
                                <table className="w-full table-fixed">
                                    ...
                                    {reportData.map((student, idx) => (
                                        <tr key={student.rollnumber} className={`${idx % 2 === 0 ? 'bg-transparent' : 'bg-zinc-50/50 dark:bg-zinc-800/20'} hover:bg-indigo-50/50 dark:hover:bg-indigo-500/5 transition-colors`}>
                                            ...
                                            <td className="w-[15%] px-2 sm:px-4 py-4 text-center">
                                                <div className="text-xs font-medium text-zinc-600 dark:text-zinc-400">{student.practicalmarks}</div>
                                            </td>
                                            ...
                                            <td className="w-[15%] px-4 py-4 text-center">
                                                <span className="inline-flex items-center justify-center px-2 py-1 rounded bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 text-[10px] sm:text-xs font-black uppercase border border-zinc-200 dark:border-zinc-700">
                                                    {student.grade}
                                                </span>
                                            </td>
                                        </tr>
                    ...
                    <div className="flex flex-col items-center justify-center py-20 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl text-center px-4 shadow-sm">
                        ...
                        <p className="text-sm text-zinc-500 mt-1 max-w-xs">Select course details above to view the comprehensive subject-wise performance report.</p>
                    </div>
                )}
            </main>
        </div>
