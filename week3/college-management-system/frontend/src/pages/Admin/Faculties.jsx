                    ...
                    <div className="border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950/50">
                        <table className="w-full table-fixed">
                            ...
                            <tr>
                                ...
                                <th className="w-[55%] sm:w-[25%] px-2 sm:px-4 py-3.5 text-left text-[10px] sm:text-xs font-bold text-zinc-500 uppercase tracking-wider">Faculty Profile</th>
                                <th className="hidden sm:table-cell sm:w-[15%] px-4 py-3.5 text-left text-[10px] sm:text-xs font-bold text-zinc-500 uppercase tracking-wider">Position</th>
                                <th className="hidden lg:table-cell lg:w-[20%] px-4 py-3.5 text-left text-[10px] sm:text-xs font-bold text-zinc-500 uppercase tracking-wider">Assignment</th>
                                <th className="hidden md:table-cell sm:w-[12%] px-4 py-3.5 text-center text-[10px] sm:text-xs font-bold text-zinc-500 uppercase tracking-wider">Status</th>
                                        ...
                                        <td className="hidden lg:table-cell lg:w-[20%] px-4 py-3">
                                            {faculty.courcecode !== "NOT ASSIGNED" ? (
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-0.5 truncate" title={faculty.subject_name}>
                                                            {faculty.subject}
                                                        </span>
                                                </div>
                                            ) : (
                                                <span className="px-2 py-1 text-[9px] font-bold bg-zinc-100 text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400 rounded uppercase tracking-wider">
                                                        Unassigned
                                                    </span>
                                            )}
                                        </td>
